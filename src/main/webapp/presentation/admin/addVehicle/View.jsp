        ...
        <div class="register">
            <div class="row">
                <div class="col-md-4 offset-md-4 mx-auto">
                    <form name="form" action="presentation/admin/addVehicle/add" method="post"  enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            <input type="text" placeholder="Año" class="form-control" id="year" name="year" required>
                        </div>
                        <div class="form-group mb-3">
